...
//!TEST
void DSlibCamera::resetSettings() {
	dsvl_vs->reacTIVision_resetParams();
}

int DSlibCamera::getCameraSettingStep(int mode) {
	return dsvl_vs->reacTIVision_getCameraSettingStep(mode);
}

int DSlibCamera::getMinCameraSetting(int mode) {
	return dsvl_vs->reacTIVision_getMinCameraSetting(mode);
}

int DSlibCamera::getMaxCameraSetting(int mode) {
	return dsvl_vs->reacTIVision_getMaxCameraSetting(mode);
}

int DSlibCamera::getCameraSetting(int mode) {
	return dsvl_vs->reacTIVision_getCameraSetting(mode);
}

bool DSlibCamera::setCameraSetting(int mode, int value) {
	return dsvl_vs->reacTIVision_setCameraSetting(mode,value);
}

bool DSlibCamera::setCameraSettingAuto(int mode, bool flag) {
	return dsvl_vs->reacTIVision_setCameraSettingAuto(mode,flag);
}
