...
CalibrationEngine::CalibrationEngine(const char* out) {
	...
	help_text.push_back("");
	help_text.push_back("------------------------------------------------");
	help_text.push_back("Camera Setting Control");
	help_text.push_back("");
	help_text.push_back("properties:");
	help_text.push_back("   b - Brightness");
	help_text.push_back("   c - Contrast");
	help_text.push_back("   s - Sharpness");
	help_text.push_back("");
	help_text.push_back("values:");
	help_text.push_back("   0..127 (property value range)");
	help_text.push_back("");
	help_text.push_back("usage:");
	help_text.push_back("   <property> <value>");
	help_text.push_back("   reset");
	help_text.push_back("------------------------------------------------");
};
